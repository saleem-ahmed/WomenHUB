    ...
    <x-auth-card>
        ...
        <a href="/">
                <div style="background-color: #fff; margin-bottom: -40px; width: 100%; border-top-left-radius: 5%; border-top-right-radius: 5px;">
                    ...
                    <h1 class="mb-5" style="padding: 20px 156px; font-weight: bold; font-size: 20px;">Mom's Kitchen</h1>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <h5 class="text-center mb-4">Customer Signup</h5>
           ...
           <div class="mt-4">
            ...
            <input type="text" name="role" value="customer" style="display: none">
